const quoteArea = document.getElementById("displayed-quote");
...
const follow = document.getElementById("followlink");
const navContainerTop = document.getElementById("nav-container-top");
const navContainer = document.getElementById("header-lg");
const textLogo = document.getElementById("textlogo-lg");
//// Logo Transition
...
//// Quote Function
for(let i = 0; i < quotes.length; i++)logosChildren[i].addEventListener("mouseenter", (event)=>{
